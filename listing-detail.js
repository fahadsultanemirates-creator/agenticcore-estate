  ...
  (async function () {
    ...
    function render() {
      ...
      const thumb = listing.photos && listing.photos.length
        ? '<img src="' + listing.photos[0] + '" alt="" style="width:100%;height:100%;object-fit:cover;">'
        : AC_HOUSE_ICON;
      const gallery = (listing.photos || []).slice(1).map(function (url) {
        return '<img src="' + url + '" alt="" style="width:100%;aspect-ratio:4/3;object-fit:cover;border-radius:var(--radius-md);">';
      }).join('');
      ...
      detailRoot.innerHTML =
        ...
        '<div class="form-grid" style="align-items:start;">' +
          '<div>' +
            ...
            '<p style="color:var(--text-secondary);margin-bottom:1rem;">' + acPropertyTypeLabel(listing.property_type) + ' · ' + listing.area + ', ' + listing.city + '</p>' +
